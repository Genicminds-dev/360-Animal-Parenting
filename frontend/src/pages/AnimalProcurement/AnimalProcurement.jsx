...
// pages/procurement/AnimalProcurement.jsx
import React, { useState, useEffect } from 'react';
import { useNavigate, useParams, useLocation } from 'react-router-dom';
import { 
  User, Phone, MapPin, Calendar, Tag,
    ...
    try {
      ...
      Object.keys(formData).forEach(key => {
        ...
        if (value && typeof value === 'object') {
          // Check if it's a File object (has name, size properties)
          if (value instanceof File) {
            formDataToSend.append(key, value);
          }
          // Check if it's our custom file object from existing files
          else if (value.isExistingFile && value.url) {
            // For existing files, we might want to send just the path or skip
