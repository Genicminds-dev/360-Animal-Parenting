  ...
  const columns = useMemo(() => [
    {
      ...
      render: (item) => (
        <div className="font-medium text-primary-600 dark:text-primary-400">{item.earTagId}</div>
      )
    },
    {
      key: "breed",
      ...
      render: (item) => (
        <div className="font-medium text-gray-800 dark:text-gray-200">{item.breed}</div>
      )
    },
    {
      key: "gender",
      ...
      render: (item) => (
        <div className="font-medium text-gray-800 dark:text-gray-200">{item.gender}</div>
      )
    },
    {
      key: "calvingStatus",
    ...
    <>
      <div className="space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Procured Animal Lists</h1>
            <p className="text-gray-600 dark:text-gray-400">View and manage all registered animals</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Total Animals */}
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
            <div className="flex items-start justify-between">
              <GiCow className="text-primary-500 dark:text-primary-400 opacity-60" size={40} />
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
            <div className="flex items-start justify-between">
              <GiCow className="text-green-500 dark:text-green-400 opacity-60" size={40} />
              <div className="text-right">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.numberOfBreeds}</h3>
                <p className="text-gray-600 dark:text-gray-400">Number of Breeds</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
            <div className="flex items-start justify-between">
              <Milk className="text-purple-500 dark:text-purple-400 opacity-60" size={40} />
              <div className="text-right">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.milkingAnimals}</h3>
                <p className="text-gray-600 dark:text-gray-400">Milking Animals</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 hover:shadow-lg transition-all duration-300 border border-gray-200 dark:border-gray-700">
            <div className="flex items-start justify-between">
              <HeartPulse className="text-pink-500 dark:text-pink-400 opacity-60" size={40} />
              <div className="text-right">
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white">{stats.pregnantAnimals}</h3>
                <p className="text-gray-600 dark:text-gray-400">Pregnant Animals</p>
              </div>
            </div>
          </div>
        </div>
