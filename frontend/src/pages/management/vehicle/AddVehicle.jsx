...
import {
    Camera, X, ChevronDown, Save, ArrowLeft, Truck, User, Users, Phone, IdCard, CreditCard, Upload, Eye, File, Image as ImageIcon, Video
} from 'lucide-react';
...
const AddVehicle = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Make API call
            const response = await api.post(Endpoints.CREATE_VEHICLE, formDataToSend, {
                headers: {
            ...
            if (response.data.success) {
                ...
                setTimeout(() => {
                    navigate(PATHROUTES.vehicles);
                }, 1500);
            } else {
                toast.error(response.data.message || 'Failed to register vehicle');
            }
        } catch (error) {
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600">Register new vehicle for animal transportation</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                step="0.1"
                                min="0.1"
                                className={`input-field ${errors.vehicleSize ? 'border-red-500' : ''}`}
                                placeholder="e.g., 2.5"
                                disabled={isSubmitting}
                            />
                            {errors.vehicleSize && (
                                <p className="text-red-500 text-xs mt-1">{errors.vehicleSize}</p>
                            )}
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    maxLength={10}
                                    className={`input-field pl-10 ${errors.driverMobile ? 'border-red-500' : ''}`}
                                    placeholder="10-digit mobile number"
                                    disabled={isSubmitting}
                                />
                            </div>
                            {errors.driverMobile && (
                                <p className="text-red-500 text-xs mt-1">{errors.driverMobile}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    maxLength={12}
                                    className={`input-field pl-10 ${errors.driverAadhar ? 'border-red-500' : ''}`}
                                    placeholder="12-digit Aadhar number"
                                    disabled={isSubmitting}
                                />
                            </div>
                            {errors.driverAadhar && (
                                <p className="text-red-500 text-xs mt-1">{errors.driverAadhar}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`input-field pl-10 ${errors.driverDL ? 'border-red-500' : ''}`}
                                    placeholder="Enter driving license number"
                                    disabled={isSubmitting}
                                />
                            </div>
                            {errors.driverDL && (
                                <p className="text-red-500 text-xs mt-1">{errors.driverDL}</p>
                            )}
                        </div>
                                        ...
                                        <div className="border-2 border-gray-300 rounded-lg p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <div className="flex space-x-2">
                                                    <button
                                                        type="button"
                                                        onClick={() => openMedia('driverPhoto', driverPhotoPreview)}
                ...
                <div className="card">
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h2 className="text-lg font-semibold text-gray-900">Helper Details</h2>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    maxLength={10}
                                    className={`input-field pl-10 ${errors.helperMobile ? 'border-red-500' : ''}`}
                                    placeholder="10-digit mobile number"
                                    disabled={isSubmitting}
                                />
                            </div>
                            {errors.helperMobile && (
                                <p className="text-red-500 text-xs mt-1">{errors.helperMobile}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    maxLength={12}
                                    className={`input-field pl-10 ${errors.helperAadhar ? 'border-red-500' : ''}`}
                                    placeholder="12-digit Aadhar number"
                                    disabled={isSubmitting}
                                />
                            </div>
                            {errors.helperAadhar && (
                                <p className="text-red-500 text-xs mt-1">{errors.helperAadhar}</p>
                            )}
                        </div>
                                        ...
                                        <div className="border-2 border-gray-300 rounded-lg p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <div className="flex space-x-2">
                                                    <button
                                                        type="button"
                                                        onClick={() => openMedia('helperPhoto', helperPhotoPreview)}
                                                        className="p-2 bg-primary-100 text-primary-600 rounded-lg hover:bg-primary-200 transition-colors"
                                                        title="Preview"
                                                        disabled={isSubmitting}
                                                    >
                                        ...
                                        <div className="border-2 border-gray-300 rounded-lg p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <div className="flex space-x-2">
                                                    <button
                                                        type="button"
                                                        onClick={() => openMedia('vehiclePhoto', vehiclePhotoPreview)}
                                                        className="p-2 bg-primary-100 text-primary-600 rounded-lg hover:bg-primary-200 transition-colors"
                                                        title="Preview"
                                                        disabled={isSubmitting}
                                                    >
                                        ...
                                        <div className="border-2 border-gray-300 rounded-lg p-6">
                                            <div className="flex items-center justify-between mb-4">
                                                ...
                                                <div className="flex space-x-2">
                                                    <button
                                                        type="button"
                                                        onClick={() => openMedia('vehicleVideo', vehicleVideoPreview)}
