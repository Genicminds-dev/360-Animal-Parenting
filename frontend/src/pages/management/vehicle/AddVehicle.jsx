    ...
    return (
        <div className="space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Vehicle Registration</h1>
                    <p className="text-gray-600 dark:text-gray-400">Register new vehicle for animal transportation</p>
                </div>
            </div>
