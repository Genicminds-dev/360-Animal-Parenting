...
const VehicleList = () => {
    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            render: (item) => (
                <div className="font-medium text-gray-800 dark:text-gray-200">{item.vehicleNumber}</div>
            )
        },
        {
            key: "vehicleType",
            ...
            render: (item) => (
                <div className="flex items-center gap-3">
                    <div>
                        <div className="font-medium text-gray-800 dark:text-gray-200">{item.vehicleType}</div>
                        <div className="text-xs text-gray-500 dark:text-gray-400">{item.vehicleSize} tons</div>
                    </div>
                </div>
            )
        },
        {
            ...
            render: (item) => (
                <div className="flex items-center gap-2">
                    <span className="text-gray-800 dark:text-gray-200">{item.driverName}</span>
                </div>
            )
        },
        {
            ...
            render: (item) => (
                <div className="flex items-center gap-2">
                    {item.helperName && item.helperName !== 'No Helper' ? (
                        <>
                            <span className="text-gray-800 dark:text-gray-200">{item.helperName}</span>
                        </>
                    ) : (
                        <span className="text-gray-400 dark:text-gray-500 text-sm">No Helper</span>
                    )}
                </div>
            )
        },
        {
            ...
            render: (item) => {
                ...
                return (
                    <div className="text-gray-800 dark:text-gray-300">{formattedDate}</div>
                );
            }
        },
            ...
            <div className="space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Manage vehicles for animal transportation</p>
                    </div>
