        ...
        <div className="space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Vaccination Details</h1>
                        <p className="text-gray-600 dark:text-gray-400">Update vaccination records for Batch: <span className='text-primary-600 dark:text-primary-400 text-sm font-medium'>{batch.batchId}</span></p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-4 border border-blue-100 dark:border-blue-800">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <span className="text-xs text-gray-500 dark:text-gray-400">Procurement Officer</span>
                        <p className="font-medium text-gray-900 dark:text-white">{batch.procurementOfficer}</p>
                    </div>
                    <div>
                        <span className="text-xs text-gray-500 dark:text-gray-400">Broker</span>
                        <p className="font-medium text-gray-900 dark:text-white">{batch.broker}</p>
                    </div>
                    <div>
                        <span className="text-xs text-gray-500 dark:text-gray-400">Source Location</span>
                        <p className="font-medium text-gray-900 dark:text-white">{batch.sourceLocation}</p>
                    </div>
                </div>
                <div className="mt-3 pt-3 border-t border-blue-200 dark:border-blue-800">
                    <div className="flex flex-wrap items-center gap-2">
                        ...
                        <span className="text-sm text-gray-600 dark:text-gray-400 font-medium">Ear Tag IDs:</span>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/30 border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
                    <div className="flex items-center space-x-3 mb-6">
                        ...
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Brucella Screening Details</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            {errors.brucellaDate && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.brucellaDate}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.brucellaResult && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.brucellaResult}</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/30 border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
                    <div className="flex items-center space-x-3 mb-6">
                        <div className="p-2 bg-green-50 dark:bg-green-900/30 rounded-lg">
                            <Syringe className="text-green-600 dark:text-green-400" size={20} />
                        </div>
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">FMD Vaccination Details</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            />
                            {errors.fmdBy && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.fmdBy}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.fmdDate && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.fmdDate}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.fmdBatchNo && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.fmdBatchNo}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.fmdExpiryDate && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.fmdExpiryDate}</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md dark:shadow-gray-900/30 border border-gray-200 dark:border-gray-700 p-6 transition-colors duration-300">
                    <div className="flex items-center space-x-3 mb-6">
                        <div className="p-2 bg-orange-50 dark:bg-orange-900/30 rounded-lg">
                            <Syringe className="text-orange-600 dark:text-orange-400" size={20} />
                        </div>
                        <h2 className="text-lg font-semibold text-gray-900 dark:text-white">LSD Vaccination Details</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            />
                            {errors.lsdBy && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.lsdBy}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.lsdDate && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.lsdDate}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            />
                            {errors.lsdBatchNo && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.lsdBatchNo}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {errors.lsdExpiryDate && (
                                <p className="text-red-500 dark:text-red-400 text-xs mt-1">{errors.lsdExpiryDate}</p>
                            )}
                        </div>
                    </div>
                </div>
                ...
                <div className="flex items-center justify-between pt-6 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button
                        type="submit"
                        disabled={isSubmitting}
                        className={`px-6 py-2 bg-primary-600 dark:bg-primary-500 text-white rounded-lg hover:opacity-90 transition-opacity flex items-center justify-center min-w-[120px] ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
                        {isSubmitting ? (
                            <>
