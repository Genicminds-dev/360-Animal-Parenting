        ...
        <>
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Holding Stations</h1>
                        <p className="text-gray-600">Manage holding stations for animal care and temporary housing</p>
                    </div>
