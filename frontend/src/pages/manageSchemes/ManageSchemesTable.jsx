    ...
    const columns = useMemo(() => [
        ...
        },
        {
            ...
            render: (item) => {
                ...
                return <span className="dark:text-gray-300">{formattedDate}</span>;
            }
        }
        ...
        <>
            <div className="space-y-6 bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Scheme Management</h1>
                        <p className="text-gray-600 dark:text-gray-400">Manage all government schemes</p>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-5 transition-colors duration-300">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-sm text-gray-600 dark:text-gray-400">Inactive Schemes</p>
