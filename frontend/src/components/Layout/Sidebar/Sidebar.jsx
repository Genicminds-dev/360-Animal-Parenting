    ...
    <div className="w-full sm:w-64 bg-white border-r border-gray-200 flex flex-col h-screen">
      ...
      <div className="p-4 border-t border-gray-200 flex-shrink-0">
        <div className="flex items-center space-x-2 sm:space-x-3 p-2 sm:p-3 rounded-lg bg-gray-50">
          <div className="w-8 h-8 sm:w-10 sm:h-10 bg-primary-600 text-white rounded-full flex items-center justify-center font-semibold flex-shrink-0 text-sm sm:text-base overflow-hidden">
            {getProfileImage() ? (
              <img 
                src={getProfileImage()} 
                alt={getDisplayName()}
