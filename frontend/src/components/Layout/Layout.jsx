  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex overflow-hidden transition-colors duration-300">
      ...
      {sidebarOpen && isMobile && (
        <div 
          className="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 z-30 lg:hidden transition-opacity duration-300"
      ...
      `}>
        ...
        <main
          ref={mainRef}
          className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 dark:bg-gray-900 transition-colors duration-300"
        > 
         <div className="p-3 sm:p-4 md:p-6 lg:p-8">
          ...
          {/* Optional Footer */}
          <footer className="mt-auto py-4 px-6 border-t border-gray-200 dark:border-gray-700 transition-colors duration-300">
